...
const conversionLch: {
  ...
  rgb: (input) => conversionLab.rgb(lchToLab(input)),
  hsl: (input) => conversionLab.hsl(lchToLab(input)),
  hwb: (input) => conversionLab.hwb(lchToLab(input)),
  lab: lchToLab,
  oklab: (input) => conversionLab.oklab(lchToLab(input)),
  oklch: (input) => conversionLab.oklch(lchToLab(input)),
};
...
const conversionOklch: {
  ...
  rgb: (input) => conversionOklab.rgb(oklchToOklab(input)),
  hsl: (input) => conversionOklab.hsl(oklchToOklab(input)),
  hwb: (input) => conversionOklab.hwb(oklchToOklab(input)),
  lab: (input) => conversionOklab.lab(oklchToOklab(input)),
  lch: (input) => conversionOklab.lch(oklchToOklab(input)),
  oklab: oklchToOklab,
};
